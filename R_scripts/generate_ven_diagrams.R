...
generate_ven_diagram <- function(ext_init_val){
  ...
  if (ext_init_val$mark_name == "Extension") {
    ...
    K56ac <- ext_init_val$H3K56ac
    K4me3 <- ext_init_val$H3K4me3
...
ggsave(plot= leaf_ext_ven_plot, filename = "imgs/ven_diagrams/leaf_ext_ven_plot.ven.svg", width = 7, height =6 )
ggsave(plot= leaf_init_ven_plot, filename = "imgs/ven_diagrams/leaf_init_ven_plot.ven.svg", width = 7, height =6 )
ggsave(plot= ear_ext_ven_plot, filename = "imgs/ven_diagrams/ear_ext_ven_plot.ven.svg", width = 7, height =6 )
ggsave(plot= ear_init_ven_plot, filename = "imgs/ven_diagrams/ear_init_ven_plot.ven.svg", width = 7, height =6 )
ggsave(plot= root_ext_ven_plot, filename = "imgs/ven_diagrams/root_ext_ven_plot.ven.svg", width = 7, height =6 )
ggsave(plot= root_init_ven_plot, filename = "imgs/ven_diagrams/root_init_ven_plot.ven.svg", width = 7, height =6 )
...
ggsave(plot= leaf_combined, filename = "imgs/ven_diagrams/leaf_combined.ven.svg", width = 5 , height =12 )
ggsave(plot= ear_combined, filename = "imgs/ven_diagrams/ear_combined.ven.svg", width = 6 , height =12 )
ggsave(plot= root_combined, filename = "imgs/ven_diagrams/root_combined.ven.svg", width = 6 , height =12 )
...
ggsave(plot= leaf_combined_side_by_side, filename = "imgs/ven_diagrams/leaf_combined_side_by_side.ven.svg", width = 12 , height =6 )
ggsave(plot= ear_combined_side_by_side, filename = "imgs/ven_diagrams/ear_combined_side_by_side.ven.svg", width = 12 , height =6 )
ggsave(plot= root_combined_side_by_side, filename = "imgs/ven_diagrams/root_combined_side_by_side.ven.svg", width = 12 , height =6 )



### Quick Math for paper. proportion occuring in both mods, etc....


(leaf_ext$H3K36me3 + leaf_ext$H3K4me1)/leaf_ext$both
