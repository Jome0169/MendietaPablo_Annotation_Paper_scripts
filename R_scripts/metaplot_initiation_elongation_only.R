...
View(leaf_initiation_only_leaf_H3K4me3_all)




bw_zipped_file <- read_delim("07.scaled_to_region/CHIP/leaf_initiation_only_leaf_input_all.gz", delim='\t', col_names = FALSE, skip = 1)
...
test <- final_return %>% 
  dplyr::select(combined_name, total) %>% 
  arrange(desc(total))
...
take_number <- nrow(leaf_initiation_only_leaf_H3K36me3_all)
...
leaf_initiation_only <- nrow(leaf_initiation_only_leaf_H2AZ_all)
...
leaf_initiation_only_control_merged_H2AZ <- combine_identical_marks_on_off(leaf_initiation_only_leaf_H2AZ_all,leaf_on_genes_leaf_H2AZ_sub_sampled)
leaf_initiation_only_control_merged_H3K27me3 <- combine_identical_marks_on_off(leaf_initiation_only_leaf_H3K27me3_all,leaf_on_genes_leaf_H3K27me3_sub_sampled)
leaf_initiation_only_control_merged_H3K36me3 <- combine_identical_marks_on_off(leaf_initiation_only_leaf_H3K36me3_all,leaf_on_genes_leaf_H3K36me3_sub_sampled)
leaf_initiation_only_control_merged_H3K4me1 <- combine_identical_marks_on_off(leaf_initiation_only_leaf_H3K4me1_all,leaf_on_genes_leaf_H3K4me1_sub_sampled)
leaf_initiation_only_control_merged_H3K4me3 <- combine_identical_marks_on_off(leaf_initiation_only_leaf_H3K4me3_all,leaf_on_genes_leaf_H3K4me3_sub_sampled)
leaf_initiation_only_control_merged_H3K56ac <- combine_identical_marks_on_off(leaf_initiation_only_leaf_H3K56ac_all,leaf_on_genes_leaf_H3K56ac_sub_sampled)
leaf_initiation_only_control_merged_input <- combine_identical_marks_on_off(leaf_initiation_only_leaf_input_all,leaf_on_genes_leaf_inp_sub_sampled)
...
ggsave(path = "/Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/", filename="leaf_initiation_only_leaf_plot_draw_2.pdf", plot=leaf_initiation_only_leaf_plot_draw, width = 15, height = 18, units = "in")
system("open /Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/leaf_initiation_only_leaf_plot_draw_2.pdf")
...
take_number <- nrow(root_initiation_only_root_H3K36me3_all)
...
root_initiation_only <- nrow(root_initiation_only_root_H2AZ_all)
...
root_initiation_only_control_merged_H2AZ <- combine_identical_marks_on_off(root_initiation_only_root_H2AZ_all,root_on_genes_root_H2AZ_sub_sampled)
root_initiation_only_control_merged_H3K27me3 <- combine_identical_marks_on_off(root_initiation_only_root_H3K27me3_all,root_on_genes_root_H3K27me3_sub_sampled)
root_initiation_only_control_merged_H3K36me3 <- combine_identical_marks_on_off(root_initiation_only_root_H3K36me3_all,root_on_genes_root_H3K36me3_sub_sampled)
root_initiation_only_control_merged_H3K4me1 <- combine_identical_marks_on_off(root_initiation_only_root_H3K4me1_all,root_on_genes_root_H3K4me1_sub_sampled)
root_initiation_only_control_merged_H3K4me3 <- combine_identical_marks_on_off(root_initiation_only_root_H3K4me3_all,root_on_genes_root_H3K4me3_sub_sampled)
root_initiation_only_control_merged_H3K56ac <- combine_identical_marks_on_off(root_initiation_only_root_H3K56ac_all,root_on_genes_root_H3K56ac_sub_sampled)
root_initiation_only_control_merged_input <- combine_identical_marks_on_off(root_initiation_only_root_input_all,root_on_genes_root_inp_sub_sampled)
...
ggsave(path = "/Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/", filename="root_initiation_only_root_plot_draw_2.pdf", plot=root_initiation_only_root_plot_draw, width = 15, height = 18, units = "in")
system("open /Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/root_initiation_only_root_plot_draw_2.pdf")
...
take_number <- nrow(ear_initiation_only_ear_H3K36me3_all)
...
ear_initiation_only <- nrow(ear_initiation_only_ear_H2AZ_all)
...
ear_initiation_only_control_merged_H2AZ <- combine_identical_marks_on_off(ear_initiation_only_ear_H2AZ_all,ear_on_genes_ear_H2AZ_sub_sampled)
ear_initiation_only_control_merged_H3K27me3 <- combine_identical_marks_on_off(ear_initiation_only_ear_H3K27me3_all,ear_on_genes_ear_H3K27me3_sub_sampled)
ear_initiation_only_control_merged_H3K36me3 <- combine_identical_marks_on_off(ear_initiation_only_ear_H3K36me3_all,ear_on_genes_ear_H3K36me3_sub_sampled)
ear_initiation_only_control_merged_H3K4me1 <- combine_identical_marks_on_off(ear_initiation_only_ear_H3K4me1_all,ear_on_genes_ear_H3K4me1_sub_sampled)
ear_initiation_only_control_merged_H3K4me3 <- combine_identical_marks_on_off(ear_initiation_only_ear_H3K4me3_all,ear_on_genes_ear_H3K4me3_sub_sampled)
ear_initiation_only_control_merged_H3K56ac <- combine_identical_marks_on_off(ear_initiation_only_ear_H3K56ac_all,ear_on_genes_ear_H3K56ac_sub_sampled)
ear_initiation_only_control_merged_input <- combine_identical_marks_on_off(ear_initiation_only_ear_input_all,ear_on_genes_ear_inp_sub_sampled)
...
ggsave(path = "/Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/", filename="ear_initiation_only_ear_plot_draw_2.pdf", plot=ear_initiation_only_ear_plot_draw, width = 15, height = 18, units = "in")
system("open /Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/ear_initiation_only_ear_plot_draw_2.pdf")
...
take_number <- nrow(leaf_elongation_only_leaf_H3K36me3_all)
take_sub_samples <- take_subsample_multi_data_frame(take_number, leaf_on_genes_leaf_H2AZ, leaf_on_genes_leaf_H3K27me3, leaf_on_genes_leaf_H3K36me3, leaf_on_genes_leaf_H3K4me1, leaf_on_genes_leaf_H3K4me3, leaf_on_genes_leaf_H3K56ac, leaf_on_genes_leaf_input)
...
leaf_elongation_only <- nrow(leaf_elongation_only_leaf_H2AZ_all)
...
leaf_elongation_only_control_merged_H2AZ <- combine_identical_marks_on_off(leaf_elongation_only_leaf_H2AZ_all,leaf_on_genes_leaf_H2AZ_sub_sampled)
leaf_elongation_only_control_merged_H3K27me3 <- combine_identical_marks_on_off(leaf_elongation_only_leaf_H3K27me3_all,leaf_on_genes_leaf_H3K27me3_sub_sampled)
leaf_elongation_only_control_merged_H3K36me3 <- combine_identical_marks_on_off(leaf_elongation_only_leaf_H3K36me3_all,leaf_on_genes_leaf_H3K36me3_sub_sampled)
leaf_elongation_only_control_merged_H3K4me1 <- combine_identical_marks_on_off(leaf_elongation_only_leaf_H3K4me1_all,leaf_on_genes_leaf_H3K4me1_sub_sampled)
leaf_elongation_only_control_merged_H3K4me3 <- combine_identical_marks_on_off(leaf_elongation_only_leaf_H3K4me3_all,leaf_on_genes_leaf_H3K4me3_sub_sampled)
leaf_elongation_only_control_merged_H3K56ac <- combine_identical_marks_on_off(leaf_elongation_only_leaf_H3K56ac_all,leaf_on_genes_leaf_H3K56ac_sub_sampled)
leaf_elongation_only_control_merged_input <- combine_identical_marks_on_off(leaf_elongation_only_leaf_input_all,leaf_on_genes_leaf_inp_sub_sampled)
...
ggsave(path = "/Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/", filename="leaf_elongation_only_leaf_plot_draw_2.pdf", plot=leaf_elongation_only_leaf_plot_draw, width = 15, height = 18, units = "in")
system("open /Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/leaf_elongation_only_leaf_plot_draw_2.pdf")
...
take_number <- nrow(root_elongation_only_root_H3K36me3_all)
take_sub_samples <- take_subsample_multi_data_frame(take_number, root_on_genes_root_H2AZ, root_on_genes_root_H3K27me3, root_on_genes_root_H3K36me3, root_on_genes_root_H3K4me1, root_on_genes_root_H3K4me3, root_on_genes_root_H3K56ac, root_on_genes_root_input)
...
root_elongation_only <- nrow(root_elongation_only_root_H2AZ_all)
...
root_elongation_only_control_merged_H2AZ <- combine_identical_marks_on_off(root_elongation_only_root_H2AZ_all,root_on_genes_root_H2AZ_sub_sampled)
root_elongation_only_control_merged_H3K27me3 <- combine_identical_marks_on_off(root_elongation_only_root_H3K27me3_all,root_on_genes_root_H3K27me3_sub_sampled)
root_elongation_only_control_merged_H3K36me3 <- combine_identical_marks_on_off(root_elongation_only_root_H3K36me3_all,root_on_genes_root_H3K36me3_sub_sampled)
root_elongation_only_control_merged_H3K4me1 <- combine_identical_marks_on_off(root_elongation_only_root_H3K4me1_all,root_on_genes_root_H3K4me1_sub_sampled)
root_elongation_only_control_merged_H3K4me3 <- combine_identical_marks_on_off(root_elongation_only_root_H3K4me3_all,root_on_genes_root_H3K4me3_sub_sampled)
root_elongation_only_control_merged_H3K56ac <- combine_identical_marks_on_off(root_elongation_only_root_H3K56ac_all,root_on_genes_root_H3K56ac_sub_sampled)
root_elongation_only_control_merged_input <- combine_identical_marks_on_off(root_elongation_only_root_input_all,root_on_genes_root_inp_sub_sampled)
...
ggsave(path = "/Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/", filename="root_elongation_only_root_plot_draw_2.pdf", plot=root_elongation_only_root_plot_draw, width = 15, height = 18, units = "in")
system("open /Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/root_elongation_only_root_plot_draw_2.pdf")
...
take_number <- nrow(ear_elongation_only_ear_H3K36me3_all)
take_sub_samples <- take_subsample_multi_data_frame(take_number, ear_on_genes_ear_H2AZ, ear_on_genes_ear_H3K27me3, ear_on_genes_ear_H3K36me3, ear_on_genes_ear_H3K4me1, ear_on_genes_ear_H3K4me3, ear_on_genes_ear_H3K56ac, ear_on_genes_ear_input)
...
ear_elongation_only <- nrow(ear_elongation_only_ear_H2AZ_all)
...
ear_elongation_only_control_merged_H2AZ <- combine_identical_marks_on_off(ear_elongation_only_ear_H2AZ_all,ear_on_genes_ear_H2AZ_sub_sampled)
ear_elongation_only_control_merged_H3K27me3 <- combine_identical_marks_on_off(ear_elongation_only_ear_H3K27me3_all,ear_on_genes_ear_H3K27me3_sub_sampled)
ear_elongation_only_control_merged_H3K36me3 <- combine_identical_marks_on_off(ear_elongation_only_ear_H3K36me3_all,ear_on_genes_ear_H3K36me3_sub_sampled)
ear_elongation_only_control_merged_H3K4me1 <- combine_identical_marks_on_off(ear_elongation_only_ear_H3K4me1_all,ear_on_genes_ear_H3K4me1_sub_sampled)
ear_elongation_only_control_merged_H3K4me3 <- combine_identical_marks_on_off(ear_elongation_only_ear_H3K4me3_all,ear_on_genes_ear_H3K4me3_sub_sampled)
ear_elongation_only_control_merged_H3K56ac <- combine_identical_marks_on_off(ear_elongation_only_ear_H3K56ac_all,ear_on_genes_ear_H3K56ac_sub_sampled)
ear_elongation_only_control_merged_input <- combine_identical_marks_on_off(ear_elongation_only_ear_input_all,ear_on_genes_ear_inp_sub_sampled)
...
ggsave(path = "/Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/", filename="ear_elongation_only_ear_plot_draw_2.pdf", plot=ear_elongation_only_ear_plot_draw, width = 15, height = 18, units = "in")
system("open /Users/feilab/Projects/03.ncRNA_project/03.Figures/Figure2/imgs/metaplots/ear_elongation_only_ear_plot_draw_2.pdf")
